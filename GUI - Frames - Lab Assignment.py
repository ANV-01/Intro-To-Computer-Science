...
mainwindow.rowconfigure(1, weight=1) #sets up the window that is going to be used
...
def func_one():
    ...
    if str_var1 == 'red':
        mainwindow.config(bg='red')
    if str_var1 == '':
        str_var1="Empty-reset"
        mainwindow.config(bg='gray95')
    L2.configure(text=str_var1)
#All functions necessary for the GUI program

# Parent widget for the buttons
top_frame = tk.Frame(mainwindow, bg="cyan", highlightbackground="black", highlightthickness=1)

top_frame.grid(row=2, column=0, columnspan=3, sticky=tk.N+tk.W+tk.E)
...
btn_b1.grid(row=0, column=2, padx=(10), pady=10) #sets up the buttons that are to be used throughout the program
...
label_1 = tk.Label(redFrame, text="A Label")
label_1.pack()

other_label = tk.Label(redFrame, text="Label B - other")
other_label.pack()

button_1 = tk.Button(redFrame, text="Button ONE", command=func_one)
button_1.pack()

two_button = tk.Button(redFrame, text="Button TWO", command=func_two)
two_button.pack()


resetButt = tk.Button(redFrame, text="do the reset", command=do_reset)
resetButt.pack()
...
B1 = tk.Button(greenFrame, text="post the entry", command=func_one)
B1.pack()
...
L1 = tk.Label(blueFrame, text="selection", font=('arial', 20))
L1.pack()
...
L2 = tk.Label(blueFrame, text="---------------------------")
L2.pack()

B1 = tk.Button(blueFrame, text="push", command=doButt)
B1.pack()
